...
(function ($) {
    ...
    $.Html = $.extend($.Element, {
        configure: function (T) {
            ...
            css: function (k, v) {
                if ($.isString(k))
                    if ($.isDefined(v)) this.dom.style[k] = v;
    ...
    (function ($) {
        ...
        var PI = Math.PI,
            ...
            complex = function (c) {
                var _ = this._(),
                    M, MI, V, d, L, init = false;
                _.labels = _.get('labels');
                L = _.labels.length;
                if (L == 0) {
                    L = c[0].value.length;
                    for (var i = 0; i < L; i++) _.labels.push("");
                }
                _.columns = [];
                _.total = 0;
                for (var i = 0; i < L; i++) {
        ...
        $.Chart = $.extend($.Painter, {
            ...
            configure: function () {
                ...
                oneWay: function (_) {
                    ...
                    var E = _.variable.event,
                        tot = !_.get('turn_off_touchmove'),
                        mCSS = !$.touch && _.get('default_mouseover_css'),
                        O, AO, events = $.touch ? ['touchstart', 'touchmove'] : ['click', 'mousemove'];
			...
			*/
                    ...
                    var H = 0,
                        ...
                        w = _.push('client_width', (_.get(_.W) - _.get('hpadding'))),
                        h;
    ...
    $.Sector2D = $.extend($.Sector, {
        configure: function () {
            ...
            tipInvoke: function () {
                var _ = this;
                return function (w, h) {
                    var P = $.p2Point(this.x, this.y, this.get('middleAngle'), this.r * 0.8),
                        Q = $.quadrantd(this.get('middleAngle'));
                    return {
        ...
        configure: function () {
            ...
            doConfig: function () {
                ...
                var _ = this._(),
                    ...
                    w,
                    I = _.coo.get(_.X) + S.basic * W,
                    x = _.coo.get(_.X) - _.get('text_space') - _.coo.get('axis.width')[3],
        ...
        configure: function () {
            ...
            drawSegment: function () {
                var _ = this._(),
                    ...
                    h = _.get('brushsize');
                if (_.get('area')) {
                    _.T.polygon(_.get('light_color2'), false, 1, '', false, _.get('area_opacity'), _.get('smooth') ? p : [{
                        x: _.x,
                        y: _.y
                    }].concat(p.concat([{
                        x: _.x + _.get(_.W),
                        y: _.y
                    }])), _.get('smooth'), _.get('smoothing'), [{
                        x: _.x,
                        y: _.y
                    }, {
                        x: _.x + _.get(_.W),
    ...
    $.Line = $.extend($.Chart, {
        ...
        configure: function () {
            ...
            doConfig: function () {
                ...
                var vw = _.get('coordinate.valid_width'),
                    vh = _.get('coordinate.valid_height');
                _.lines = [];
